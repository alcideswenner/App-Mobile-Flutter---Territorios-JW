  ...
  static Container buildSectionHeader(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text("Meus mapas", style: Theme.of(context).textTheme.title,),
          FlatButton(
            onPressed: (){},
            child: Text("Escolher novo mapa", style: TextStyle(color: Colors.blue),),
          )
        ],
      ),
    );
            ...
            child: Material(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Text("Olá "+usuario, style: Theme.of(context).textTheme.title),
                  SizedBox(height: 5.0,),
          ...
          Row(
            ...
            children: <Widget>[
              Material(
                ...
                child: CircleAvatar(
                  radius: 40.0,
                  backgroundImage: NetworkImage("https://image.flaticon.com/icons/png/512/44/44948.png")
                  ),
              ),
            ],
          ),
