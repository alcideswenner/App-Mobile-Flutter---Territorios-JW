...
import 'package:territorios/widgets/cardOffline.dart';
import 'package:toast/toast.dart';

class MapasGrupo extends StatefulWidget {
  @override
  MapasGrupoState createState() => MapasGrupoState();
}

class MapasGrupoState extends State<MapasGrupo> {
                        ...
                        try {
                          ...
                          if (result.isNotEmpty &&
                            ...
                            if (item.status == "Em Escolha") {
                              ...
                              Toast.show("Mapa Indisponível!", context,
                                  duration: Toast.LENGTH_LONG,
                                  gravity: Toast.CENTER);
                            }
                          } else {
